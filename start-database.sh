...
DB_CONTAINER_NAME="learning-t3-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=learning-t3 -d -p 5432:5432 docker.io/postgres
